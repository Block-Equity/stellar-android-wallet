...
public class PatchedSearchableListDialog extends DialogFragment implements
    ...
    public PatchedSearchableListDialog() {

    }

    public static PatchedSearchableListDialog newInstance(List items) {
        PatchedSearchableListDialog multiSelectExpandableFragment = new
                PatchedSearchableListDialog();
