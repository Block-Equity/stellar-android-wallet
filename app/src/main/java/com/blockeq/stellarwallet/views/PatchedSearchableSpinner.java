...
public class PatchedSearchableSpinner extends Spinner implements View.OnTouchListener,
    ...
    private List _items;
    private PatchedSearchableListDialog _searchableListDialog;
    ...
    public PatchedSearchableSpinner(Context context) {
        super(context);
        this._context = context;
        init();
    }

    public PatchedSearchableSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        this._context = context;
    ...
    public PatchedSearchableSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        _searchableListDialog = PatchedSearchableListDialog.newInstance
                (_items);
    ...
    public void setOnSearchTextChangedListener(PatchedSearchableListDialog.OnSearchTextChanged onSearchTextChanged) {
